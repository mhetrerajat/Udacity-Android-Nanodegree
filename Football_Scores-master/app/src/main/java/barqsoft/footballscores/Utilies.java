...
public class Utilies {
    ...
    public static String getLeague(int league_num) {
        ...
        switch (league_num) {
            ...
            case CHAMPIONS_LEAGUE:
                return res.getString(R.string.champ_league);
            case PRIMERA_DIVISION:
                return res.getString(R.string.primera_division);
            case BUNDESLIGA:
                return res.getString(R.string.bundesliga_series);
            default:
                return res.getString(R.string.not_known_league);
        }
    }
    ...
    public static String getMatchDay(int match_day, int league_num) {
        ...
        if (league_num == CHAMPIONS_LEAGUE) {
            if (match_day <= 6) {
                return res.getString(R.string.match_day_6);
            } else if (match_day == 7 || match_day == 8) {
                return res.getString(R.string.knockout_round);
            } else if (match_day == 9 || match_day == 10) {
                return res.getString(R.string.match_day_9);
            } else if (match_day == 11 || match_day == 12) {
                return res.getString(R.string.match_day_11);
            } else {
                return res.getString(R.string.final_match);
            }
        } else {
